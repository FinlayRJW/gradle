...
final class GenericPageRenderer extends TabbedPageRenderer<TestTreeModel> {
    ...
    public static String getUrlTo(
        ...
        java.nio.file.Path relativePath = Paths.get("./" + HtmlTestReportPath.buildFilePath(shrink, originatingPath, isOriginatingPathLeaf)).getParent()
            .relativize(Paths.get("./" + HtmlTestReportPath.buildFilePath(shrink, targetPath, isTargetPathLeaf)));
